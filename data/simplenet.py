...
class MVTecSSN(MVTecSingle):
    def __init__(self, root_path: str, category: str, is_train: bool = True, image_size: tuple = (256, 256), repeat=50):
    ...
    def __getitem__(self, index: int) -> tuple:
        ...
        if self.is_train:
            return image, self.labels[index], torch.zeros((self.image_size[0], self.image_size[1]), dtype=torch.float32)
        else:
